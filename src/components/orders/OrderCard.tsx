...
import { formatCurrency, formatDateShort, getStatusColor, getStatusLabel } from '@/lib/order-utils'
    ...
    <Card className="overflow-hidden border-l-4 border-l-amber-500 hover:shadow-lg transition-shadow">
      <div className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 py-4 border-y border-slate-200 dark:border-slate-700">
          <div>
            <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Order Date</p>
          ...
          <div>
            <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Items</p>
          ...
          <div>
            <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Item Count</p>
            <p className="font-medium text-slate-900 dark:text-white">
